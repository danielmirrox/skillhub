      ...
      <div className="relative grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        <article className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-slate-950/30 backdrop-blur-xl">
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            ...
            <span className="rounded-full border border-white/10 bg-white/5 px-3 py-2 text-slate-200">Поиск участников</span>
            <span className="rounded-full border border-white/10 bg-white/5 px-3 py-2 text-slate-200">Лента команд</span>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            <article className="rounded-2xl border border-white/10 bg-slate-950/55 p-4">
              ...
              <p className="mt-2 text-2xl font-semibold text-white">MVP</p>
            ...
            <article className="rounded-2xl border border-white/10 bg-slate-950/55 p-4">
              ...
              <p className="mt-2 text-sm text-slate-400">Платёжный экран уже есть, потом подключится YuMoney.</p>
            </article>
          </div>
        </article>
        ...
        <aside className="rounded-[2rem] border border-white/10 bg-slate-950/70 p-6 shadow-2xl shadow-slate-950/35 backdrop-blur-xl">
          <div className="rounded-[1.5rem] border border-white/10 bg-gradient-to-br from-cyan-300/15 via-slate-950 to-violet-400/10 p-6">
            ...
            <h3 className="mt-3 text-2xl font-semibold text-white">{user ? "Продолжить работу" : "Войти и показать MVP"}</h3>
