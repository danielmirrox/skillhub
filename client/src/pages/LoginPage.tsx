    ...
    <section className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
      <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-slate-950/30 backdrop-blur-xl">
        ...
        <h2 className="mt-5 max-w-2xl text-4xl font-semibold leading-tight tracking-tight text-white sm:text-5xl">
          SkillHub превращает поиск команды в визуально ясный и быстрый процесс.
        </h2>
        <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-300">
          GitHub OAuth временно заменён демо-входом, чтобы можно было безопасно тестировать поиск,
          PRO-видимость, отклики и редактирование профиля без лишних барьеров.
        </p>

        <div className="mt-6 flex flex-wrap gap-3 text-sm">
          <span className="rounded-full border border-white/10 bg-white/5 px-3 py-2 text-slate-200">Search</span>
          <span className="rounded-full border border-white/10 bg-white/5 px-3 py-2 text-slate-200">AI rating</span>
          <span className="rounded-full border border-white/10 bg-white/5 px-3 py-2 text-slate-200">Applications</span>
          <span className="rounded-full border border-white/10 bg-white/5 px-3 py-2 text-slate-200">GitHub import</span>
        </div>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          <article className="rounded-2xl border border-white/10 bg-slate-950/55 p-4">
            ...
            <p className="mt-2 text-2xl font-semibold text-white">1 click</p>
            <p className="mt-2 text-sm text-slate-400">Попадаешь в дашборд и сразу видишь product flow.</p>
          </article>
          <article className="rounded-2xl border border-white/10 bg-slate-950/55 p-4">
          ...
          <article className="rounded-2xl border border-white/10 bg-slate-950/55 p-4">
            ...
            <p className="mt-2 text-sm text-slate-400">Search → profile → applications → scoring работает end-to-end.</p>
          </article>
        </div>
      </div>
      ...
      <aside className="rounded-[2rem] border border-white/10 bg-slate-950/70 p-6 shadow-2xl shadow-slate-950/35 backdrop-blur-xl">
        <div className="rounded-[1.5rem] border border-white/10 bg-gradient-to-br from-cyan-300/15 via-slate-950 to-violet-400/10 p-6">
          <p className="text-sm uppercase tracking-[0.24em] text-cyan-300">Launch panel</p>
          <h3 className="mt-3 text-2xl font-semibold text-white">Войти в демо</h3>
          <p className="mt-3 text-sm leading-7 text-slate-300">
            Выбирай обычный или PRO-режим, чтобы проверить весь интерфейс в реальном состоянии без
            GitHub OAuth.
          </p>
