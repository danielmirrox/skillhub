...
**Важно:** Точный формат зависит от версии YandexGPT API. Проверьте актуальную документацию: [https://cloud.yandex.ru/docs/yandexgpt/](https://cloud.yandex.ru/docs/yandexgpt/)
...
- GitHub OAuth: [https://docs.github.com/en/developers/apps/building-oauth-apps](https://docs.github.com/en/developers/apps/building-oauth-apps)
- GitHub REST API: [https://docs.github.com/en/rest](https://docs.github.com/en/rest)
- YandexGPT: [https://cloud.yandex.ru/docs/yandexgpt/](https://cloud.yandex.ru/docs/yandexgpt/)
- Yandex Cloud: [https://cloud.yandex.ru/](https://cloud.yandex.ru/)
